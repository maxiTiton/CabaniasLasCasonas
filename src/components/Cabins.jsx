  ...
  return (
    <section id="cabanas" className="section cabins reveal-on-scroll" ref={sectionRef}>
      <div className="container">
        ...
        <div className="cabins-tabs reveal-on-scroll">
          {cabins.map((cabin, index) => (
            <button
              key={cabin.id}
              className={`cabin-tab reveal-on-scroll ${activeCabin === index ? 'active' : ''}`}
        ...
        <div className="cabin-details">
          ...
          <div className="cabin-info">
            ...
            <div className="cabin-amenities reveal-on-scroll">
              <h4>Comodidades incluidas:</h4>
              <div className="amenities-grid reveal-on-scroll">
                {cabins[activeCabin].amenities.map((amenity, index) => (
                  <div key={index} className="amenity-item reveal-on-scroll">
